function TMX_Default(platform) { 
  ...
  if ('PSA'=='PASSBACK') {
    ...
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=1837289252652975&id=4&bid=' + platform + '"></scr' + 'ipt>');
  } else {
    ...
    document.write('<script type="text/javascript" src="' + (tmIsSecure ? 'https' : 'http') + '://uat-net.technoratimedia.com/pixel?rid=1837289252652975&id=3&bid=' + platform + '"></scr' + 'ipt>');
  }
}
function TMX_OpenX(auid) {
  ...
  document.write("		src=\"" + (document.location.protocol=="https" ? "https" : "http") + ":\/\/uat-net.technoratimedia.com\/pixel?rid=1837289252652975&id=2&bid=OPX&sid=20721&cp=' + a.getProperties().pub_rev + '\">");
