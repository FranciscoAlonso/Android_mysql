...
ALTER TABLE `historial_caso`
  ...
  ADD CONSTRAINT `FKD8E3C9CADDADB17F` FOREIGN KEY (`medico_id`) REFERENCES `medico` (`id`) ON UPDATE CASCADE;

ALTER TABLE `opinion`
  ADD CONSTRAINT `FKB4EDB382575F15CE` FOREIGN KEY (`caso_id`) REFERENCES `caso` (`id`) ON UPDATE CASCADE ON DELETE CASCADE,
  ADD CONSTRAINT `FKB4EDB382DDADB17F` FOREIGN KEY (`medico_id`) REFERENCES `medico` (`id`) ON UPDATE CASCADE;
